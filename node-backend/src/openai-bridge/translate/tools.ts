...
import type { AnthropicToolDefinition, AnthropicToolChoice } from '../types/anthropic.js';
import type { OpenAIToolDefinition, OpenAIToolChoice, OpenAIToolCall } from '../types/openai.js';
