...
use objc2::{rc::Retained, runtime::ProtocolObject, DefinedClass};
...
use super::class::{
  ...
  wry_navigation_delegate::NavigationDelegateClass,
};

// Download action handler
pub(crate) fn navigation_download_action<T: NavigationDelegateClass>(
  this: &T,
  _webview: &WKWebView,
...
pub(crate) fn navigation_download_response<T: NavigationDelegateClass>(
  this: &T,
  _webview: &WKWebView,
