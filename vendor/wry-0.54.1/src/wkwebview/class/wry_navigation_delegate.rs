...
use objc2::{
  define_class, msg_send, rc::Retained, runtime::NSObject, ClassType, DeclaredClass,
  MainThreadOnly,
};
...
pub(crate) trait NavigationDelegateClass: DeclaredClass<Ivars = WryNavigationDelegateIvars> {}
...
impl NavigationDelegateClass for WryNavigationDelegate {}

define_class!(
  #[unsafe(super(NSObject))]
  #[name = "WryNavigationDownloadDelegate"]
  #[thread_kind = MainThreadOnly]
  #[ivars = WryNavigationDelegateIvars]
  pub struct WryNavigationDownloadDelegate;

  unsafe impl NSObjectProtocol for WryNavigationDownloadDelegate {}

  unsafe impl WKNavigationDelegate for WryNavigationDownloadDelegate {
    #[unsafe(method(webView:decidePolicyForNavigationAction:decisionHandler:))]
    fn navigation_policy(
      &self,
      webview: &WKWebView,
...
impl NavigationDelegateClass for WryNavigationDownloadDelegate {}

fn new_navigation_delegate<T: NavigationDelegateClass>(
  ...
  <T as ClassType>::Super: ClassType,
{
  ...
  let delegate = mtm.alloc::<T>().set_ivars(WryNavigationDelegateIvars {
    pending_scripts,
...
impl WryNavigationDownloadDelegate {
  #[allow(clippy::too_many_arguments)]
  pub fn new(
    webview: Retained<WryWebView>,
    pending_scripts: Arc<Mutex<Option<Vec<String>>>>,
